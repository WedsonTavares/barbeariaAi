 ...
 * DEPOIS de registrar a nota (`/api/agent/pos-festa`) e agradecer o cliente.
 *
 ...
 * sair. Tira a tag "pos-festa": a próxima mensagem deste telefone volta pro
...
export async function POST(req: Request) {
  ...
  return NextResponse.json({ ok: true, message: "Atendimento de pós-festa encerrado." });
}
